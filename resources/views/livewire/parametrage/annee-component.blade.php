                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">Libellé de l'année</label>
                                                <input type="text" placeholder="2024-2025" wire:model="libelle"
                                                    class="form-control">
                                            </div>
                                            <div>
                                                @error('libelle')
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        <th scope="col"><b>Libellé de l'année</b></th>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end">
                                                    {{ $annees->links('pagination::bootstrap-5') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
