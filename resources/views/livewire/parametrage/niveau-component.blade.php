                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page">Niveau d'étude</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">Libellé du niveau</label>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        <th scope="col"><b>Libellé du niveau</b></th>
