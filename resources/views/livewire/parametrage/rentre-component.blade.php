...
<div>
                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page">Nos rentrées</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">titre de la rentrée</label>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        <th scope="col"><b>Titre de la rentrée</b></th>
                                                        <th scope="col"><b>Mois de paiement</b></th>
                                                        <th class="text-center" scope="col"><b>Actions</b></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <!--[if BLOCK]><![endif]-->
                                                    @forelse($rentres as $item)
                                                        <tr style="text-align: center;">
                                                            <td>{{ $item->titre }}</td>
                                                            <td><button wire:click="addMois({{ $item->id }})"
                                                                    class="btn btn-warning">Mois de scolairité</button>
                                                            </td>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end">
                                                    {{ $rentres->links('pagination::bootstrap-5') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div wire:ignore.self class="modal fade" id="addRentre" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr style="text-align: center;">
                                    <th scope="col" class="text-white"><b>Mois de paiement</b></th>
                                    <th scope="col" class="text-center text-white"><b>Actions</b></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($mois as $mo)
                                    <tr>
                                        <td class="text-center"><b>{{ $mo->mois }}</b></td>
                                        <td class="text-center">
                                            <button wire:click="linker({{ $mo->id }})"
                                                class="btn {{ $this->having($mo->id) ? 'btn-success' : 'btn-warning' }} ">Associée
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
