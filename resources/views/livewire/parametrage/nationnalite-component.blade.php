                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page">Nationnalités</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">Libellé de la nationnalité</label>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        <th scope="col"><b>Libellé nationnalité</b></th>
                                                        <th class="text-center" scope="col"><b>Actions</b></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <!--[if BLOCK]><![endif]-->
                                                    @forelse($nationnalites as $item)
                                                        <tr style="text-align: center;">
                                                            <td>{{ $item->libelle }}</td>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end">
                                                    {{ $nationnalites->links('pagination::bootstrap-5') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
