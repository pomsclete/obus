                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page">Spécialités des
                                            formations</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">Libellé de la spécialité</label>
                                            ...
                                            <div class="form-group mt-3">
                                                <label for="input-search">Sigle</label>
                                                <input type="text" wire:model="sigle" class="form-control">
                                            </div>
                                            <div>
                                                @error('sigle')
                                                    <small
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr style="text-align: center;">
                                                        <th scope="col"><b>Libellé de la spécialité</b></th>
                                                        <th scope="col"><b>Sigle</b></th>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end">
                                                    {{ $specialites->links('pagination::bootstrap-5') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
