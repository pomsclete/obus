                    ...
                    <div class="d-flex breadcrumb-content">
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">Home Application</li>
                                </ol>
                            </nav>
                        ...
                        <li class="nav-item more-dropdown">
                            <div class="dropdown  custom-dropdown-icon">
                                <a class="dropdown-toggle btn _effect--ripple waves-effect waves-light" href="#"
                                    role="button" id="customDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <span>Settings</span>
                ...
                <div class="kb-widget-section">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xxl-2 col-xl-3 col-lg-3 mb-lg-0 col-md-6 mb-3">
                            <div class="card" wire:click="getUrl('dashboard-finance')">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-2 col-xl-3 col-lg-3 mb-lg-0 col-md-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-0">PEDAGOGIE</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-2 col-xl-3 col-lg-3 mb-lg-0 col-md-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-0">SCOLARITE</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-2 col-xl-3 col-lg-3 mb-lg-0 col-md-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-0">PARAMETRES</h5>
                                </div>
                            </div>
                        </div>
