                        ...
                        <div class="d-flex breadcrumb-content">
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page">Frais d'inscription</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="input-search">Montant inscription</label>
                                        ...
                                        <div class="row d-flex justify-content-between mt-4">
                                            <div class="col-lg-12 col-md-12 col-sm-12 filtered-list-search mx-auto">
                                                <input type="text" wire:model.live="search"
                                                    ...
                                                    placeholder="Rechercher par année scolaire,montant ou niveau">
                                            </div>
